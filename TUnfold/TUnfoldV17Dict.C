...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TUnfoldV17*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TUnfoldV17", ::TUnfoldV17::Class_Version(), "Analysis/VVAnalysis/TUnfold/TUnfold.h", 106,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TUnfoldSysV17*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TUnfoldSysV17", ::TUnfoldSysV17::Class_Version(), "Analysis/VVAnalysis/TUnfold/TUnfoldSys.h", 58,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TUnfoldDensityV17*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TUnfoldDensityV17", ::TUnfoldDensityV17::Class_Version(), "invalid", 56,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TUnfoldBinningV17*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TUnfoldBinningV17", ::TUnfoldBinningV17::Class_Version(), "Analysis/VVAnalysis/TUnfold/TUnfoldBinning.h", 57,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TUnfoldBinningXMLV17*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TUnfoldBinningXMLV17", ::TUnfoldBinningXMLV17::Class_Version(), "invalid", 268,
...
"/data/uhussain/ZZTo4l/ZZ2018/UnfoldingAnalysisTools/CMSSW_8_0_26/src/Analysis/VVAnalysis/TUnfold/",
0
    };
...
class __attribute__((annotate(R"ATTRDUMP(Unfolding with support for L-curve analysis)ATTRDUMP"))) __attribute__((annotate("$clingAutoload$TUnfoldSys.h")))  TUnfoldV17;
