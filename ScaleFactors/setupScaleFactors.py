...
mCBMedFakeRate = ROOT.ScaleFactor("mCBMedFakeRate", "Fake rate from dijet control, by Svenja")
mCBMedFakeRate.Set2DHist(float2double(fakeRateFile.Get('m/medium/fakeratePtEta')), 0, 0, ROOT.ScaleFactor.NearestEntry)
mCBTightFakeRate = ROOT.ScaleFactor("mCBTightFakeRate", "Fake rate from dijet control, by Svenja")
