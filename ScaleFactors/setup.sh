...
wget http://fcouderc.web.cern.ch/fcouderc/EGamma/scaleFactors/ichep2016_80X/resultsEleID/runBCD/passingTight/egammaEffi.txt_SF2D.root ichepElectronTightSF.root -O data/ichepElectronTightSF.root
exit
