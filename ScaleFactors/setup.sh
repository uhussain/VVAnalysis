...
wget http://fcouderc.web.cern.ch/fcouderc/EGamma/scaleFactors/Moriond17/approval/EleID/passingTight80X/egammaEffi.txt_EGM2D.root -O ../data/moriondElectronTightSF.root
wget http://fcouderc.web.cern.ch/fcouderc/EGamma/scaleFactors/Moriond17/approval/EleID/passingMVA80Xwp80/egammaEffi.txt_EGM2D.root -O ../data/moriondElectronMVA80SF.root
wget http://fcouderc.web.cern.ch/fcouderc/EGamma/scaleFactors/Moriond17/approval/EleID/passingMVA80Xwp90/egammaEffi.txt_EGM2D.root -O ../data/moriondElectronMVA90SF.root
